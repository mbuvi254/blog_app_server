...
export const createNewBlog = async (req:AuthenticatedRequest,res:Response)=>{
    try{
...
export const getBlog = async (req:AuthenticatedRequest,res:Response)=>{
    try{
        const {id}=req.params;
...
export const trashBlog = async (req:AuthenticatedRequest,res:Response)=>{
    try{
        const {id}=req.params;
        const blogId = String(id);
        const authorId=req.user?.id;
...
export const restoreBlog = async (req:AuthenticatedRequest,res:Response)=>{
    try{
        const {id}=req.params;
        const blogId = String(id);
        const authorId=req.user?.id;
